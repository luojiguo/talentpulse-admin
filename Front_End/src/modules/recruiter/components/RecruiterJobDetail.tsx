...
const RecruiterJobDetail: React.FC<RecruiterJobDetailProps> = ({ job, onBack, currentUserId, currentUser, companyAddress, jobs = [] }) => {
    // 面试邀请模态框状态
                ...
                <div className="space-y-6">
                    <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                        ...
                        <div className="grid grid-cols-1 gap-3 mt-4">
                            <button className="w-full py-2.5 bg-emerald-600 text-white font-bold rounded-lg hover:bg-emerald-700 transition shadow-sm text-sm">
                                查看候选人列表
                            </button>
                            <button 
